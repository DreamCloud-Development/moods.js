<template>
    <div>
        ...
        <div class="mx-2 lg:mx-10">
            <div role="tablist" class="tabs tabs-bordered tabs-lg font-bold mt-4 w-full">
                ...
                <div role="tabpanel" class="tab-content" v-if="playlists.length != 0">
                    <p><br>This one work.<br><br>But Audius Not.</p>
                    <div v-for="playlist in playlists">
                ...
                <div role="tabpanel" class="tab-content" v-if="users.length != 0">
                    <p><br>This things is bugged.<br><br>But like really.</p>
